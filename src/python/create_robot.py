...
if __name__ == "__main__":
    ...
    #mesh = createLatticeMesh(1,1,1,None,0.,0.,0.)
    ...
    for i in range(len(mesh.elsetList['voxelSectionList'])):
        ...
        geomFile.write('*BEAM SECTION, SECTION=RECTANGULAR, ELSET=%s, MATERIAL=Matl_1\n'%(name))
    ...
    geomFile.write('*SHELL SECTION, ELSET=SHELLS, MATERIAL=Matl_1\n')
    geomFile.write(' .1\n')
    geomFile.write('*BEAM SECTION, SECTION=CIRC, ELSET=BEAM_feet_connectors, MATERIAL=Matl_1\n')
    geomFile.write(' .2\n')
...
##    geomFile.write('\n')
    ...
    #geomFile.write('1.0E-4,3.E-4,1.0E-8,.01\n')     # mesh check
