...
GTM_wing_3s;
nodes = GTM_wing_3s_data*scaleFactor;
...
completeSections = 20;     % from post-processing
for i=1:completeSections
    skipList = [14,15,16,17,18, 19];
    ...
    [nr nc] = size(curWingSection.curves(1).pos);
    fprintf('section %d, at %f, num nodes on curve 1 %d\n',i,curConstCoord, nr);
    [nr nc] = size(curWingSection.curves(2).pos);
    fprintf('section %d, at %f, num nodes on curve 2 %d\n',i,curConstCoord, nr);
